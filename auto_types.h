...
typedef struct {
  ...
  doublereal *aa;  /*array output (but must be initialized to 0) size: *nca X
                      *nra X *na */
  doublereal *bb;  /*array output (but must be initialized to 0) size: *ncb X
                      *nra X *na */
  doublereal *cc;  /*array output (but must be initialized to 0) size: *nca X
                      *nrc X *na */
  doublereal
