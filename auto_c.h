...
#define STPNT_TYPE_BVP(X)                                                      \
    int32 X(iap_type *iap, rap_type *rap, double *par, int64 *icp, int64 *ntsrs, \
...
FNCS_TYPE_AE(fnhbae);
FNCS_TYPE_AE(fnuzae);
int32 stbif(iap_type *iap, rap_type *rap, double *par, int64 *icp, int64 *m1aaloc,
...
int32 headng(iap_type *iap, rap_type *rap, double *par, int64 *icp, int64 iunit,
           int64 *n1, int64 *n2);
int32 stplae(iap_type *iap, rap_type *rap, double *par, int64 *icp, double *rlcur,
           double *u);
...
int32 adapt(iap_type *iap, rap_type *rap, int64 *nold, int64 *ncold, int64 *nnew,
...
int32 scaleb(iap_type *iap, int64 *icp, int64 *ndxloc, double *dvps, double *rld,
...
int32 tpspbv(iap_type *iap, rap_type *rap, double *par, int64 *icp,
           doublecomplex *ev);
int32 stplbv(iap_type *iap, rap_type *rap, double *par, int64 *icp, double *rldot,
           int64 *ndxloc, double *ups, double *udotps, double *tm, double *dtm,
           double *thl, double *thu);
int32 wrtbv8(iap_type *iap, rap_type *rap, double *par, int64 *icp, double *rldot,
           int64 *ndxloc, double *ups, double *udotps, double *tm, double *dtm);
int32 wrtbv9(iap_type *iap, rap_type *rap, double *par, int64 *icp, double *rlcur,
...
int32 conrhs(int64 *nov, int64 *na, int64 *nra, int64 *nca, double *a, int64 *nbc,
...
/* autlib3.c */
FUNI_TYPE(fnlp);
int32 fflp(const iap_type *iap, const rap_type *rap, int64 ndim, const double *u,
...
FUNI_TYPE(fnc2);
int32 ffc2(const iap_type *iap, const rap_type *rap, int64 ndim, const double *u,
         const double *uold, const int64 *icp, double *par, double *f,
         int64 ndm, double *dfdu, double *dfdp);
...
FUNI_TYPE(fnti);
FUNI_TYPE(fnhd);
int32 ffhd(const iap_type *iap, const rap_type *rap, int64 ndim, const double *u,
         const double *uold, const int64 *icp, double *par, double *f,
         int64 ndm, double *dfdu, double *dfdp);
STPNT_TYPE_AE(stpnhd);
FUNI_TYPE(fnhb);
int32 ffhb(const iap_type *iap, const rap_type *rap, int64 ndim, const double *u,
         const double *uold, const int64 *icp, double *par, double *f,
         int64 ndm, double *dfdu, double *dfdp);
STPNT_TYPE_AE(stpnhb);
FUNI_TYPE(fnhw);
int32 ffhw(const iap_type *iap, const rap_type *rap, int64 ndim, const double *u,
         const double *uold, const int64 *icp, double *par, double *f,
         int64 ndm, double *dfdu, double *dfdp);
...
FUNI_TYPE(fnws);
int32 ffws(const iap_type *iap, const rap_type *rap, int64 ndim, const double *u,
...
int32 stpnwp(iap_type *iap, rap_type *rap, double *par, int64 *icp, int64 *ntsr,
           ...
           int64 *nodir, double *thl, double *thu);
FUNI_TYPE(fnsp);
int32 ffsp(const iap_type *iap, const rap_type *rap, int64 ndim, const double *u,
         const double *uold, const int64 *icp, double *par, int64 ijac,
         double *f, double *dfdu, double *dfdp, int64 ndm, double *dfu,
         double *dfp);
FUNI_TYPE(fnpe);
int32 ffpe(const iap_type *iap, const rap_type *rap, int64 ndim, const double *u,
         const double *uold, const int64 *icp, double *par, int64 ijac,
         double *f, double *dfdu, double *dfdp, int64 ndm, double *dfu,
         double *dfp);
ICNI_TYPE(icpe);
FUNI_TYPE(fnpl);
int32 ffpl(const iap_type *iap, const rap_type *rap, int64 ndim, const double *u,
         const double *uold, const int64 *icp, double *par, double *f,
         int64 ndm, double *dfdu, double *dfdp);
BCNI_TYPE(bcpl);
ICNI_TYPE(icpl);
int32 stpnpl(iap_type *iap, rap_type *rap, double *par, int64 *icp, int64 *ntsr,
           ...
           int64 *nodir, double *thl, double *thu);
FUNI_TYPE(fnpd);
int32 ffpd(const iap_type *iap, const rap_type *rap, int64 ndim, const double *u,
         const double *uold, const int64 *icp, double *par, double *f,
         int64 ndm, double *dfdu, double *dfdp);
BCNI_TYPE(bcpd);
ICNI_TYPE(icpd);
int32 stpnpd(iap_type *iap, rap_type *rap, double *par, int64 *icp, int64 *ntsr,
           ...
           int64 *nodir, double *thl, double *thu);
FUNI_TYPE(fntr);
int32 fftr(const iap_type *iap, const rap_type *rap, int64 ndim, const double *u,
         const double *uold, const int64 *icp, double *par, double *f,
         int64 ndm, double *dfdu, double *dfdp);
...
int32 stpntr(iap_type *iap, rap_type *rap, double *par, int64 *icp, int64 *ntsr,
           ...
           int64 *nodir, double *thl, double *thu);
FUNI_TYPE(fnpo);
int32 ffpo(const iap_type *iap, const rap_type *rap, int64 ndim, const double *u,
...
FUNI_TYPE(fnbl);
int32 ffbl(const iap_type *iap, const rap_type *rap, int64 ndim, const double *u,
         const double *uold, const int64 *icp, double *par, double *f,
         int64 ndm, double *dfdu, double *dfdp);
BCNI_TYPE(bcbl);
...
BCNI_TYPE(bcni);
ICNI_TYPE(icni);
int32 fopi(const iap_type *iap, const rap_type *rap, int64 ndim, const double *u,
...
/* autlib5.c */
FUNI_TYPE(fnho);
int32 ffho(const iap_type *iap, const rap_type *rap, int64 ndim, const double *u,
         const double *uold, const int64 *icp, double *par, double *f,
         int64 ndm, double *dfdu, double *dfdp);
BCNI_TYPE(bcho);
...
int32 balanc(int64 *nm, int64 *n, double *a, int64 *low, int64 *igh,
           double *scale);
int32 balbak(int64 *nm, int64 *n, int64 *low, int64 *igh, double *scale, int64 *m,
           double *z__);
int32 elmhes(int64 *nm, int64 *n, int64 *low, int64 *igh, double *a,
           int64 *int__);
int32 eltran(int64 *nm, int64 *n, int64 *low, int64 *igh, double *a, int64 *int__,
           double *z__);
...
int32 daxpy(int64 *n, double *da, double *dx, int64 *incx, double *dy,
          int64 *incy);
int32 drot(int64 *n, double *dx, int64 *incx, double *dy, int64 *incy, double *c,
         double *s);
...
int32 hqr3lc(double *a, double *v, int64 *n, int64 *nlow, int64 *nup, double *eps,
...
int32 ortran(int64 *nm, int64 *n, int64 *low, int64 *igh, double *a, double *ort,
           double *z__);
...
int32 conpar(int64 *nov, int64 *na, int64 *nra, int64 *nca, double *a, int64 *ncb,
