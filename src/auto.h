...
int32 auto_nox_close(int32 flag);
...
int32 auto_nox_par_to_name(int32 index, char *s);
int32 auto_nox_per_par(void);
int32 auto_nox_params(void);
int32 auto_nox_num_par(void);
int32 auto_nox_plot_par(void);
int32 auto_fit(void);
int32 auto_zoom(int32 i1, int32 j1, int32 i2, int32 j2);
int32 auto_nox_xy_plot(double *x, double *y1, double *y2, double par1, double par2, double per,
                       double *uhigh, double *ulow, double *ubar, double a);
int32 auto_nox_plot_point(int32 flag2, int32 icp1, int32 icp2);
int32 auto_nox_add_ps_point(double *par, double per, double *uhigh, double *ulow, double *ubar,
                            double a, int32 type, int32 flag, int32 lab, int32 npar, int32 icp1,
                            int32 icp2, int32 flag2, double *evr, double *evi);
int32 auto_nox_add_point(double *par, double per, double *uhigh, double *ulow, double *ubar,
                         double a, int32 type, int32 flag, int32 lab, int32 npar, int32 icp1,
                         int32 icp2, int32 flag2, double *evr, double *evi);
...
void auto_nox_new_info(int32 ibr, int32 pt, char *ty, int32 lab, double *par, double norm,
...
int32 auto_nox_new_ss(void);
int32 auto_new_discrete(void);
int32 auto_nox_extend_ss(void);
...
int32 auto_nox_new_per(void);
int32 auto_nox_2p_limit(int32 ips);
int32 auto_nox_2p_branch(void);
int32 auto_nox_branch_choice(int32 ibr);
int32 auto_nox_2p_fixper(void);
int32 auto_nox_err(char *s);
int32 auto_nox_run(void);
