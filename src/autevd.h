...
void autevd_addbif(iap_type *iap, int64 ntots, int64 ibrs, double *par, int64 *icp, int32 labw,
                   double *a, double *uhigh, double *ulow, double *u0, double *ubar);
void autevd_init_auto(int32 ndim, int32 nicp, int32 ips, int32 irs, int32 ilp, int32 ntst,
