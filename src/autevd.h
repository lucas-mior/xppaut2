...
void addbif(iap_type *iap, int64 ntots, int64 ibrs, double *par,
...
int32 eigrf_(double *a, int32 *n, int32 *m, doublecomplex *ecv, double *work,
             int32 *ier);
void init_auto(int32 ndim, int32 nicp, int32 ips, int32 irs,
               int32 ilp, int32 ntst, int32 isp, int32 isw, int32 nmx,
               int32 npr, double ds, double dsmin, double dsmax, double rl0,
               double rl1, double a0, double a1, int32 ip1, int32 ip2,
               int32 ip3, int32 ip4, int32 ip5, double epsl,
