...
/* histogram.c */
int32 two_d_hist(int32 col1, int32 col2, int32 ndat, int32 n1, int32 n2, double xlo,
...
int32 cross_spectrum(float *data, float *data2, int32 nr, int32 win, int32 w_type,
