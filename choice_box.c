...
void destroy_choice(p) CHOICE_BOX p;
{
  waitasec(ClickTime);
...
void display_choice(w, p) Window w;
CHOICE_BOX p;
{
  int i;
  int n = p.n;
...
void base_choice(wname, n, mcc, names, check, type) int type, mcc, n, *check;
char **names, *wname;
{
