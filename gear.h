...
void do_sing(double *x, double eps, double err, double big, int32 maxit, int32 n,
...
void get_evec(double *a, double *anew, double *b, double *bp, int32 n, int32 maxit,
...
int32 ggear(int32 n, double *t, double tout, double *y, double hmin, double hmax,
          double eps, int32 mf, double *error, int32 *kflag, int32 *jstart,
          double *work, int32 *iwork);
