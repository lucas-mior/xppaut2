...
int32 symplect3(double *y, double *tim, double dt, int32 nt, int32 neq, int32 *istart,
              double *work);
int32 discrete(double *y, double *tim, double dt, int32 nt, int32 neq, int32 *istart,
             double *work);
int32 bak_euler(double *y, double *tim, double dt, int32 nt, int32 neq, int32 *istart,
              double *work);
...
void one_step_rk4(double *y, double dt, double *yval[3], int32 neq, double *tim);
void one_step_heun(double *y, double dt, double *yval[2], int32 neq, double *tim);
int32 euler(double *y, double *tim, double dt, int32 nt, int32 neq, int32 *istart,
          double *work);
int32 mod_euler(double *y, double *tim, double dt, int32 nt, int32 neq, int32 *istart,
              double *work);
int32 rung_kut(double *y, double *tim, double dt, int32 nt, int32 neq, int32 *istart,
             double *work);
int32 adams(double *y, double *tim, double dt, int32 nstep, int32 neq, int32 *ist,
          double *work);
